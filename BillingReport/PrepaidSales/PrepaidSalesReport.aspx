<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrepaidSalesReport.aspx.cs"
    Inherits="PrepaidSalesReport" %>
                    ...
                    <tr>
                        ...
                        <td colspan="2" valign="top">
                            <asp:UpdatePanel ID="up2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlBranch" runat="server" GroupingText="Branch Wise Sales" Height="400px"
                                        Width="100%" Font-Size="10pt" Visible="False">
