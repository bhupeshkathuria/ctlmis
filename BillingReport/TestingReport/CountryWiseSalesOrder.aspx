                                        ...
                                        <table id="Table1" width="100%" border="0" cellpadding="0" cellspacing="0" runat="server">
                                            <tr>
                                                <td style="text-align: left; vertical-align: top">
                                                    <%--<asp:Chart ID="ChartMonth" runat="server" Palette="BrightPastel" BackColor="#D3DFF0"
                                                        ...
                                                        <Titles>
                                                            <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 10.25pt, style=Bold" ShadowOffset="0"
                                                                Text="Country (Month Wise) Sales Order" ForeColor="26, 59, 105">
                                                            </asp:Title>
                                                        </Titles>
                                                        <Legends>
                                                            <asp:Legend Enabled="true" LegendItemOrder="ReversedSeriesOrder" ItemColumnSpacing="1"
                                                                Alignment="Near" IsDockedInsideChartArea="true" IsTextAutoFit="true" Name="Default"
                                                        ...
                                                        <Series>
                                                            <asp:Series YValueType="String" XValueType="Double" IsValueShownAsLabel="true" IsVisibleInLegend="true"
                                                                IsXValueIndexed="true" ChartArea="ChartAreaMonth" Name="SeriesMonth" ChartType="Funnel"
                                                                CustomProperties="FunnelMinPointHeight=1" BorderColor="180, 26, 59, 105" Color="220, 65, 140, 240">
                                                            </asp:Series>
                                                        </Series>
                                                        <ChartAreas>
                                                            <asp:ChartArea Name="ChartAreaMonth" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                                                                ...
                                                                <InnerPlotPosition Auto="true" />
                                                                <AxisY LineColor="64, 64, 64, 64" IsLabelAutoFit="False">
                                                                    <LabelStyle Font="Trebuchet MS, 7.25pt, style=Bold" Format="0.0," />
                                                                    <MajorGrid LineColor="64, 64, 64, 64" />
                                                                </AxisY>
                                                                <AxisX LineColor="64, 64, 64, 64" IsLabelAutoFit="false">
                                                                    <LabelStyle Font="Trebuchet MS, 7.25pt, style=Bold" />
