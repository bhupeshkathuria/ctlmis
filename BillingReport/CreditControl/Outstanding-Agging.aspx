<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Outstanding-Agging.aspx.cs" Inherits="CreditControl_Outstanding_Agging"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <script>
        ...
        function callreport(branchid, brname, mevel) {
            window.open("Outstanding-Agging.aspx?branchid=" + branchid + "&name=" + brname + "&level=" + mevel, '_self', false);
        }
       function callreportfirstlevel(branchid, mevel) {
            window.open("Outstanding-Agging.aspx?branchid=" + branchid + "&level=" + mevel, '_self', false);

        }
        function callreportcustomer(branchid, custid, mevel) {
            window.open("Outstanding-Agging.aspx?branchid=" + branchid + "&custid=" + custid + "&level=" + mevel, '_self', false);


        }
    </script>
    <%--    
    <asp:UpdatePanel ID="UdpMain" ChildrenAsTriggers="False" UpdateMode="Conditional" runat="server">
        <ContentTemplate>--%>
