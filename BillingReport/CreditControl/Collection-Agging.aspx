<%@ Page Title="CollectionAgging" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"CodeFile="Collection-Agging.aspx.cs"Inherits="CreditControl_Outstanding_Agging"EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <script>
        ...
        function callreport(branchid, brname,monthid,yearid, mevel) {
            window.open("Collection-Agging.aspx?branchid=" + branchid + "&name=" + brname + "&month=" + monthid + "&year=" + yearid + "&level=" + mevel, '_self', false);


        }
        function callreportcustomer(branchid, custid, monthid, yearid, mevel) {
            window.open("Collection-Agging.aspx?branchid=" + branchid + "&custid=" + custid + "&month=" + monthid + "&year=" + yearid + "&level=" + mevel, '_self', false);
    ...
    <div style="width: 100%; padding: 0px 0px 0px 0px; font: 11px verdana;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td style="padding-left: 20px">
                    ...
                    <asp:GridView ID="grdagging_2" Width="850px" ShowFooter="True" runat="server" OnRowDataBound="grdagging_2_RowDataBound"
        ...
        <ProgressTemplate>
            <div align="center" style="position: absolute; top: 50%; left: 40%; text-align: center;
                z-index: 100002 !important">
               <img src="../PrepaidSales/loading.gif" width="100" height="100" class="ajax-loader" />
                Processing ...
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>--%>
