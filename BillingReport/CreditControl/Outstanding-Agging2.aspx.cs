...
public partial class Outstanding_Agging2 : System.Web.UI.Page
{
    ...
    private void getreport_Customerwise(int brid)
    {
        try
        {
            ...
            dt2.Columns.Add("0-15", typeof(System.Double));
            dt2.Columns.Add("15-30", typeof(System.Double));
            dt2.Columns.Add("30-45", typeof(System.Double));
            dt2.Columns.Add("45-60", typeof(System.Double));
            dt2.Columns.Add("60-90", typeof(System.Double));
            dt2.Columns.Add("90-120", typeof(System.Double));
            dt2.Columns.Add("120-160", typeof(System.Double));
            dt2.Columns.Add("160 Above", typeof(System.Double));
            ...
            decimal _outstanding5 = 0;
            decimal _outstanding6 = 0;
            decimal _outstanding7 = 0;
            decimal _outstanding8 = 0;
            int oldcustid = 0;
            decimal _total = 0;
            #endregion
            ...
            ds_aggging = cre.Get_Outstanding_Agging_New(brid);
            ...
            if (ds_aggging.Tables["customerwise"].Rows.Count > 0)
            {
                foreach (DataRow dr in ds_aggging.Tables["customerwise"].Rows)
                {
                    ...
                    if (customerid != oldcustid)
                    {
                        ...
                        DataRow[] dr_outstanding5 = ds_aggging.Tables["customerwise"].Select("xtype=" + 5 + " and customerid=" + customerid);
                        DataRow[] dr_outstanding6 = ds_aggging.Tables["customerwise"].Select("xtype=" + 6 + " and customerid=" + customerid);
                        DataRow[] dr_outstanding7 = ds_aggging.Tables["customerwise"].Select("xtype=" + 7 + " and customerid=" + customerid);
                        DataRow[] dr_outstanding8 = ds_aggging.Tables["customerwise"].Select("xtype=" + 8 + " and customerid=" + customerid);
                        ...
                        #region 60 to 90
                        if (dr_outstanding5.Length > 0)
                        {
                            if (dr_outstanding5[0]["total"] != DBNull.Value)
                            {
                                _outstanding5 = Convert.ToDecimal(ConvertToMoneyFormat(Convert.ToDouble(dr_outstanding5[0]["total"])));
                                _total += _outstanding5;
                            }
                            else
                            {
                                _outstanding5 = 0;// Convert.ToDecimal(dr_april_bill[0]["amount"]);
                                _total += _outstanding5;
                            }
                        }
                        else
                        ...
                        #region 90 to 120
                        if (dr_outstanding6.Length > 0)
                        {
                            if (dr_outstanding6[0]["total"] != DBNull.Value)
                            {
                                _outstanding6 = Convert.ToDecimal(ConvertToMoneyFormat(Convert.ToDouble(dr_outstanding6[0]["total"])));
                                _total += _outstanding6;
                            }
                            else
                            {
                                _outstanding6 = 0;// Convert.ToDecimal(dr_april_bill[0]["amount"]);
                                _total += _outstanding6;
                            }
                        }
                        else
                        ...
                        #region 120 to 160
                        if (dr_outstanding7.Length > 0)
                        {
                            if (dr_outstanding7[0]["total"] != DBNull.Value)
                            {
                                _outstanding7 = Convert.ToDecimal(ConvertToMoneyFormat(Convert.ToDouble(dr_outstanding7[0]["total"])));
                                _total += _outstanding7;
                            }
                            else
                            {
                                _outstanding7 = 0;// Convert.ToDecimal(dr_april_bill[0]["amount"]);
                                _total += _outstanding7;
                            }
                        }
                        else
                        ...
                        #region 160 Above
                        if (dr_outstanding8.Length > 0)
                        {
                            if (dr_outstanding8[0]["total"] != DBNull.Value)
                            {
                                _outstanding8 = Convert.ToDecimal(ConvertToMoneyFormat(Convert.ToDouble(dr_outstanding8[0]["total"])));
                                _total += _outstanding8;
                            }
                            else
                            {
                                _outstanding8 = 0;// Convert.ToDecimal(dr_april_bill[0]["amount"]);
                                _total += _outstanding8;
                            }
                        }
                        else
                        ...
                        dr_["0-15"] = _outstanding1.ToString();
                        dr_["15-30"] = _outstanding2.ToString();
                        dr_["30-45"] = _outstanding3.ToString();
                        dr_["45-60"] = _outstanding4.ToString();
                        dr_["60-90"] = _outstanding5.ToString();
                        dr_["90-120"] = _outstanding6.ToString();
                        dr_["120-160"] = _outstanding7.ToString();
                        dr_["160 Above"] = _outstanding8.ToString();
                ...
                for (int i = 0; i < grdagging_2.Rows.Count; i++)
                {
                    ...
                    grdagging_2.Rows[i].Cells[10].Visible = false;
                    grdagging_2.HeaderRow.Cells[10].Visible = false;
                }
            }        
        }
        catch (Exception ex)
    ...
    private void getreport_CustomerwiseDeatil(int brid,int custid)
    {
        try
        {
            ...
            Clay.Sale.Bll.CreditDetail cre = new Clay.Sale.Bll.CreditDetail();
            DataSet ds_aggging = new DataSet();
            ds_aggging = cre.Get_Agging_customer_Details_new(brid, custid);
    ...
    private void getreport()
    {
        try
        {
            ...
            dt.Columns.Add("0-15", typeof(System.Double));
            dt.Columns.Add("15-30", typeof(System.Double));
            dt.Columns.Add("30-45", typeof(System.Double));
            dt.Columns.Add("45-60", typeof(System.Double));
            dt.Columns.Add("60-90", typeof(System.Double));
            dt.Columns.Add("90-120", typeof(System.Double));
            dt.Columns.Add("120-160", typeof(System.Double));
            dt.Columns.Add("160 Above", typeof(System.Double));
            ...
            Clay.Sale.Bll.CreditDetail cre = new Clay.Sale.Bll.CreditDetail();
            DataSet ds_aggging = new DataSet();
            ds_aggging = cre.Get_Outstanding_Agging_New(0);
            ...
            if (ds_aggging.Tables["Outstanding1"].Rows.Count > 0)
            {
                foreach (DataRow dr in ds_aggging.Tables["branch"].Rows)
                {
                    ...
                    DataRow[] dr_outstanding5 = ds_aggging.Tables["Outstanding5"].Select("branchid=" + branchid);
                    DataRow[] dr_outstanding6 = ds_aggging.Tables["Outstanding6"].Select("branchid=" + branchid);
                    DataRow[] dr_outstanding7 = ds_aggging.Tables["Outstanding7"].Select("branchid=" + branchid);
                    DataRow[] dr_outstanding8 = ds_aggging.Tables["Outstanding8"].Select("branchid=" + branchid);
                    //0 to 60
    ...
    private void Wholeoutstanding()
    {
        try
        {
            ...
            ds_aggging_nobranch = cre.Get_Outstanding_Agging_WthoutBranch_new();
       ...
       // System.Threading.Thread.Sleep(500);   
        ...
        if (mylevel == 0)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string hlink2 = "javascript:callreport('" + branchid + "','" + parmbranchname + "','1')";
                ...
                grdagging_2.HeaderRow.Cells[8].HorizontalAlign = HorizontalAlign.Right;
                e.Row.Cells[8].HorizontalAlign = HorizontalAlign.Right;

                grdagging_2.HeaderRow.Cells[10].HorizontalAlign = HorizontalAlign.Right;
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[7].HorizontalAlign = HorizontalAlign.Right;
                e.Row.Cells[8].HorizontalAlign = HorizontalAlign.Right;
                e.Row.Cells[10].HorizontalAlign = HorizontalAlign.Right;  // this column[5] for branch id but we show total in this col
        ...
        if (mylevel == 1)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string customerid = e.Row.Cells[9].Text;
                string branchid = e.Row.Cells[10].Text;
                ...
                grdagging_2.HeaderRow.Cells[11].HorizontalAlign = HorizontalAlign.Right;
                ...
                TotalAmt += decimal.Parse(e.Row.Cells[11].Text);
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[11].Text = TotalAmt.ToString(); 
            }
        }
        #endregion
