<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchWiseSalesOrder.aspx.cs" Inherits="Report_BranchWiseSalesOrder" %>
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="PanelCharT1" runat="server" Visible="false">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:RadioButton ID="rbtrupees" runat="server" GroupName="Value" Checked="true" AutoPostBack="true"
                                                            BackColor="#F5F7FB" BorderStyle="None" Text="No" 
                                        ...
                                        <asp:Chart ID="Chart1" runat="server" Width="562px" Height="200px" BorderColor="181, 64, 1"
                                            ...
                                            BorderWidth="2" onclick="Chart1_Click" >
                                            <Titles>
                                            ...
                                            <Series>
                                                <asp:Series Name="Series1" YValueType="String" XValueType="Double" 
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:RadioButton ID="rbtRupeesmonth" runat="server" GroupName="ValueFormat" Checked="true"
                                                            AutoPostBack="true" BackColor="#F8EBD8" BorderStyle="None"  Text="No"
