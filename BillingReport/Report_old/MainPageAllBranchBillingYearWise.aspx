<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MainPageAllBranchBillingYearWise.aspx.cs" Inherits="Report_AllBranchBillingYearWiseMainPage" %>
...
<asp:UpdatePanel ID="UdpWindow" runat="server">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                <telerik:RadWindow ID="RadWindowAllBranchBillingYearWise" 
                   ...
                   Left="0px"
                    ...
                    Width="1220px"
                    Height="550px"
                    Title="All Branch billing Month And Day Wise"
