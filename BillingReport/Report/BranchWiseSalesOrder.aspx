<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchWiseSalesOrder.aspx.cs"
    Inherits="Report_BranchWiseSalesOrder" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Branch Wise Sales Order report</title>
</head>
<body>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:RadioButton ID="rbtrupees" runat="server" GroupName="Value" Checked="true" AutoPostBack="true"
                                                            BackColor="#F5F7FB" BorderStyle="None" Text="No" OnCheckedChanged="rbtrupees_CheckedChanged" />
                                                    </td>
                                                    <td>
                                        ...
                                        <asp:Chart ID="Chart1" runat="server" Width="562px" Height="200px" BorderColor="181, 64, 1"
                                            ...
                                            <Titles>
                                                <asp:Title ShadowColor="32, 0, 0, 0" Alignment="MiddleCenter" Font="Trebuchet MS, 14.25pt, style=Bold"
                                                    ShadowOffset="0" Text="Branch (year Wise) Sales Order" ForeColor="26, 59, 105">
                                                </asp:Title>
                                            </Titles>
                                            <BorderSkin SkinStyle="Emboss" />
                                            <Series>
                                                <asp:Series Name="Series1" YValueType="String" XValueType="Double" IsValueShownAsLabel="true"
                                    ...
                                    <asp:Panel ID="panelChart2" runat="server" Visible="false">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:RadioButton ID="rbtRupeesmonth" runat="server" GroupName="ValueFormat" Checked="true"
                                                            AutoPostBack="true" BackColor="#F8EBD8" BorderStyle="None" Text="No" OnCheckedChanged="rbtRupeesmonth_CheckedChanged" />
                                        ...
                                        <table id="Table1" width="100%" border="0" cellpadding="0" cellspacing="0" runat="server">
                                            <tr>
                                                ...
                                                <td style="text-align: left; vertical-align: top">
                                                    <asp:Chart ID="Chart_Country_SalesOrder" runat="server" Width="562px" Height="200px" BorderColor="181, 64, 1"
                                                        Palette="BrightPastel" BorderDashStyle="Solid" BackGradientStyle="TopBottom"
                                                        BorderWidth="2" BackColor="#F3DFC1" >
                                                        <Titles>
                                                            <asp:Title ShadowColor="32, 0, 0, 0" Alignment="MiddleCenter" Font="Trebuchet MS, 14.25pt, style=Bold"
                                                                ShadowOffset="0" Text="Country Sales Order" ForeColor="26, 59, 105">
                                                            </asp:Title>
                                                        </Titles>
                                                        <BorderSkin SkinStyle="Emboss" />
                                                        <Series>
                                                            <asp:Series Name="Series_Country_SalesOrder" YValueType="String" XValueType="Int64" IsValueShownAsLabel="true"
                                                                ChartArea="ChartArea_Country_SalesOrder" ChartType="Bar" CustomProperties="DrawingStyle=Cylinder"
                                                                BorderColor="180, 26, 59, 105" Color="220, 65, 140, 240">
                                                            </asp:Series>
                                                        </Series>
                                                        <ChartAreas>
                                                            <asp:ChartArea Name="ChartArea_Country_SalesOrder" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                                                                BackSecondaryColor="White" BackColor="OldLace" ShadowColor="Transparent">
                                                                <AxisY2 Enabled="False">
                                                                </AxisY2>
                                                                <AxisX2 Enabled="False">
