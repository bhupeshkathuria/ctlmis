...
public partial class Report_MainReportFormatPage : System.Web.UI.Page
{
    int userId = 0;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Session["CustomerType"] = rbtnCustomerType.SelectedValue;
            RadWindowCountryWise.NavigateUrl = "~/Report/CountryWissBillingReport.aspx";
            RadWindowSegmentBranchWise.NavigateUrl = "~/Report/BranchWiseBillingReport.aspx";
        }
    }
}