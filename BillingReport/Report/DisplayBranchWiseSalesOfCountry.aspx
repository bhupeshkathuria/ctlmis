<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayBranchWiseSalesOfCountry.aspx.cs" Inherits="Report_DisplayBranchWiseSalesOfCountry" %>
                        ...
                        <td style="vertical-align: top;">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" BorderWidth="1" BorderStyle="Outset" Visible="true"
                                            ...
                                            <table width="30px" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="drpShowAllBranchSales" runat="server" Width="80" AutoPostBack="true"
                                                            BackColor="#F3DFC1" 
                                                            onselectedindexchanged="drpShowAllBranchSales_SelectedIndexChanged" >
                                                            <asp:ListItem Text="Top 10" Value="10"></asp:ListItem>
                                                            <asp:ListItem Text="Top 15" Value="15"></asp:ListItem>
                                                            <asp:ListItem Text="Top 20" Value="20"></asp:ListItem>
                                                            <asp:ListItem Text="All" Value="0"></asp:ListItem>
                                    ...
                                    <input id="hiddenFromDate" runat="server" value="" name="HiddenFromDate" type="hidden"/>
                                    <input id="hiddenToDate" runat="server" value="" name="HiddenFromDate" type="hidden"/>
                                    <input id="hiddenMonthValue" runat="server" value="" name="HiddenFromDate" type="hidden"/>
