...
public partial class MISReport_rptSaleBillMonthWisePopUP : System.Web.UI.Page
{
    int branchid = 0;
    ...
    protected void RAFRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            Label lbltotalSalesForce = (Label)e.Item.FindControl("lbltotalSalesForce");


            sale_grand_total += Convert.ToDecimal(lblsalegrandtotal.Text);
            billing_grand_total += Convert.ToDecimal(lblbillinggrandtotal.Text);
            salesforceGrandTotal += Convert.ToDecimal(lbltotalSalesForce.Text);
            ...
            apr_salesforce += Convert.ToDecimal(lblaprSalesForce.Text);
            may_salesforce += Convert.ToDecimal(lblmaySalesForce.Text);
            jun_salesforce += Convert.ToDecimal(lbljunSalesForce.Text);
            jul_salesforce += Convert.ToDecimal(lbljulSalesForce.Text);
            aug_salesforce += Convert.ToDecimal(lblaugSalesForce.Text);
            sep_salesforce += Convert.ToDecimal(lblsepSalesForce.Text);
            oct_salesforce += Convert.ToDecimal(lbloctSalesForce.Text);
            nov_salesforce += Convert.ToDecimal(lblnovSalesForce.Text);
            dec_salesforce += Convert.ToDecimal(lbldecSalesForce.Text);
            jan_salesforce += Convert.ToDecimal(lbljanSalesForce.Text);
            feb_salesforce += Convert.ToDecimal(lblfebSalesForce.Text);
            mar_salesforce += Convert.ToDecimal(lblmarSalesforce.Text);
        ...
        if (e.Item.ItemType == ListItemType.Footer)
        {
            ...
            //Label lblaprsalesforcetotal = (Label)e.Item.FindControl("lblaprsalesforcetotal");
            //Label lblmaysalesforcetotal = (Label)e.Item.FindControl("lblmaysalesforcetotal");
            //Label lbljunsalesforcetotal = (Label)e.Item.FindControl("lbljunsalesforcetotal");
            //Label lbljulsalesforcetotal = (Label)e.Item.FindControl("lbljulsalesforcetotal");
            //Label lblaugsalesforcetotal = (Label)e.Item.FindControl("lblaugsalesforcetotal");
            //Label lblsepsalesforcetotal = (Label)e.Item.FindControl("lblsepsalesforcetotal");
            //Label lbloctsalesforcetotal = (Label)e.Item.FindControl("lbloctsalesforcetotal");
            //Label lblnovsalesforcetotal = (Label)e.Item.FindControl("lblnovsalesforcetotal");
            //Label lbldecsalesforcetotal = (Label)e.Item.FindControl("lbldecsaleseforcetotal");
            //Label lbljansalesforcetotal = (Label)e.Item.FindControl("lbljansalesforcetotal");
            //Label lblfebsalesforcetotal = (Label)e.Item.FindControl("lblfebsalesforcetotal");
            //Label lblmarsalesforcetotal = (Label)e.Item.FindControl("lblmarsalesforcetotal");
            //Label lblgrandsalesforcetotal = (Label)e.Item.FindControl("lblgrandsalesforcetotal");

            //lblaprsalesforcetotal.Text = apr_salesforce.ToString();
            //lblmaysalesforcetotal.Text = may_salesforce.ToString();
            //lbljunsalesforcetotal.Text = jun_salesforce.ToString();
            //lbljulsalesforcetotal.Text = jul_salesforce.ToString();
            //lblaugsalesforcetotal.Text = aug_salesforce.ToString();
            //lblsepsalesforcetotal.Text = sep_salesforce.ToString();
            //lbloctsalesforcetotal.Text = oct_salesforce.ToString();
            //lblnovsalesforcetotal.Text = nov_salesforce.ToString();
            //lbldecsalesforcetotal.Text = dec_salesforce.ToString();
            //lbljansalesforcetotal.Text = jan_salesforce.ToString();
            //lblfebsalesforcetotal.Text = feb_salesforce.ToString();
            //lblmarsalesforcetotal.Text = mar_salesforce.ToString();

            //lblgrandsalesforcetotal.Text = salesforceGrandTotal.ToString();
