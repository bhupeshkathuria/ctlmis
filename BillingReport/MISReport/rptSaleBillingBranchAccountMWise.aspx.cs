...
public partial class MISReport_rptSaleCategoryMonthBranchWise : System.Web.UI.Page
{
    ...
    void bindDataToDataSet(int iFromYear, int iToYear, string strBranchParameter)
    {
        try
        {
            ...
            ds = objReport.rptSalesBillingBranchAccountManagerWiseNew(fromYear, toYear, strBranchParameter);

            // we have four tabels -- branch,salecategory,sale,billing
            ...
            //{
            string[] strBranchList = strBranchParameter.Split(','); // getBranchName(ds).Split(',');
