...
public partial class MISReport_DailyBillingReport : System.Web.UI.Page
{
    ...
    double totalAmountATB = 0;
    double totalServiceTaxATB = 0;

    double totalCountATB = 0;
    ...
    protected void RadGrid1New_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            Label lblTotalAmountATB = item.FindControl("lblTotalAmountATB") as Label;
            if (lblTotalAmountATB.Text != "")
            {
                totalAmountATB += Convert.ToDouble(lblTotalAmountATB.Text); 
            }

            Label lblTotalServiceTaxAmountATB = item.FindControl("lblTotalServiceTaxAmountATB") as Label;
            if (lblTotalServiceTaxAmountATB.Text != "")
            {
                totalServiceTaxATB += Convert.ToDouble(lblTotalServiceTaxAmountATB.Text);
            }

            Label lblCountATB = item.FindControl("lblCountATB") as Label;
            if (lblCountATB.Text != "")
            {
                totalCountATB += Convert.ToDouble(lblCountATB.Text);
            }
        ...
        if (e.Item is GridFooterItem)
        {
            ...
            Label lblGrandTotalAmountATB = item.FindControl("lblGrandTotalAmountATB") as Label;
            Label lblGrandTotalServiceTaxAmountATB = item.FindControl("lblGrandTotalServiceTaxAmountATB") as Label;
            Label lblGrandTotalCountATB = item.FindControl("lblGrandTotalCountATB") as Label;
            ...
            lblGrandTotalAmountATB.Text = totalAmountATB.ToString();
            lblGrandTotalServiceTaxAmountATB.Text = totalServiceTaxATB.ToString();
            lblGrandTotalCountATB.Text = totalCountATB.ToString();
    ...
    protected string bindReportRETAIL(DateTime dtFromDate, DateTime dtToDate, DataSet ds, int customertypeid)
    {
        ...
        double totalAmountATBAll = 0;
        double totalServiceTaxATBAll = 0;
        ...
        while (dtFromDate <= dtToDate)
        {
            ...
            strReport += "<colgroup span='10' style='background-color:white'></colgroup>";
            strReport += "<tr style='font-weight:bold;background-color:#e0e5f5;color:black'>";

            // Print the Month and Year on the header ***********************************
            strReport += "<td colspan='10' align='center'>" + Monthheader(dtFromDate.Month) + "-" + dtFromDate.Year + "  (" + custType + ") </td> </tr>";
            ...
            strReport += "<td style='width:135px'> Revenue Amount(ATB) </td>";
            strReport += "<td style='width:135px'> Service Tax(ATB) </td>";
            strReport += "<td style='width:135px'> Invoice(ATB) </td>";
            ...
            for (int i = 1; i <= 31; i++)
            {
                ...
                if (foundRows.Length > 0)
                {
                    ...
                    try
                    {
                        ...
                        totalAmountATB += Convert.ToInt32(dsnew.Tables[0].Rows[0]["totalAmountATB"]);
                        totalServiceTaxATB += Convert.ToInt32(dsnew.Tables[0].Rows[0]["totalServiceTaxATB"]);


                        totalAmountATBAll += Convert.ToInt32(dsnew.Tables[0].Rows[0]["totalAmountATB"]); ;
                        totalServiceTaxATBAll += Convert.ToInt32(dsnew.Tables[0].Rows[0]["totalServiceTaxATB"]);

                        totalCountATB += Convert.ToInt32(dsnew.Tables[0].Rows[0]["countATB"]);

                        totalCountATBAll += Convert.ToInt32(dsnew.Tables[0].Rows[0]["countATB"]);
            ...
            for (int i = 1; i <= 31; i++)
            {
                ...
                if (foundRows.Length > 0)
                {
                    ...
                    try
                    {
                        totalAmountATB = Convert.ToDouble(dsnew.Tables[0].Rows[0]["totalAmountATB"]);
                    }
                    catch (Exception ex)
                    {
                        totalAmountATB = 0;
                    ...
                    try
                    {
                        totalServiceTaxATB = Convert.ToDouble(dsnew.Tables[0].Rows[0]["totalServiceTaxATB"]);
                    }
                    catch (Exception ex)
                    {
                        totalServiceTaxATB = 0;
                    ...
                    try
                    {
                        totalCountATB = Convert.ToDouble(dsnew.Tables[0].Rows[0]["countATB"]);
                    }
                    catch (Exception ex)
                    {
                        totalCountATB = 0;
                ...
                // code added to show ATB Data

                if (string.Format("{0:0.00}", totalAmount) != "0.00")
                {
                    strReport += "<td align='Right' style='color:Green'>" + Moneycomma(Math.Round(totalAmountATB, 2).ToString()) + "</td>";
                }
                else
                {
                    strReport += "<td align='Right'>" + Moneycomma(Math.Round(totalAmountATB, 2).ToString()) + "</td>";
                }


                if (string.Format("{0:0.00}", totalAmount) != "0.00")
                {
                    strReport += "<td align='Right' style='color:Green'>" + Moneycomma(Math.Round(totalServiceTaxATB, 2).ToString()) + "</td>";
                }
                else
                {
                    strReport += "<td align='Right'>" + Moneycomma(Math.Round(totalServiceTaxATB, 2).ToString()) + "</td>";
                }

                strReport += "<td align='Right' style='color:Green'>" + totalCountATB + "</td>";
            ...
            strReport += "<td align='Right'>" + Moneycomma(Math.Round(totalAmountATBAll, 2).ToString()) + " </td>";
            strReport += "<td align='Right'>" + Moneycomma(Math.Round(totalServiceTaxATBAll, 2).ToString()) + " </td>";

            strReport += "<td align='Right'>" + Math.Round(totalCountATBAll, 2).ToString() + " </td>";
