<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleBillingBranchYearWisePopUP.aspx.cs"
    Inherits="MISReport_rptSaleBillingBranchYearWise" %>
            ...
            <table width="100%" cellpadding="5px" cellspacing="0">
                <tr>
                    ...
                    <td class="Header_text" align="right">
                        <asp:Label ID="err" runat="server" Visible="false" ForeColor="Red" Font-Bold="true">
                        </asp:Label>
                    </td>
                </tr>
            </table>
            ...
            <asp:Repeater ID="RAFRepeater" runat="server" OnItemDataBound="RAFRepeater_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr id="drow" runat="server" class="GridviewScrollItem">
                        <td align="left">
                            <asp:Label ID="lblYear" Visible="false" runat="server" Text='<%#Eval("yearfromto") %>' />
                            <asp:HyperLink ID="hpNew" runat="server" Text='<%#Eval("yearfromto") %>' 
                              NavigateUrl='<%# "rptSaleBillingBranchAccountMWise.aspx?yearfromto=" + Eval("yearfromto") + "&branchname=" + Eval("branchname") %>'
                                                    onclick="window.open (this.href, 'popupwindow', 'toolbar=no,width=1300,height=800, location=no,left=0,top=0, directories=no, status=no, menubar=no, scrollbars=yes, resizable=0, copyhistory=no,fullscreen=no'); return false;"></asp:HyperLink>
                        </td>
                        <td align="left">
