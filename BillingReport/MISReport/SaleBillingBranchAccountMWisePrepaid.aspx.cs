...
public partial class MISReport_rptSaleCategoryMonthBranchWisePrepaid : System.Web.UI.Page
{
   ...
   static DataSet dssalecopy = new DataSet();
    ...
    private void BindManager()
    {
        ...
        dsEmployee = objSalesSummaryReport.GetManagerByCategory(SalesCategoryId);
        if (dsEmployee.Tables.Count > 0)
        {
            DataRow dr1;
