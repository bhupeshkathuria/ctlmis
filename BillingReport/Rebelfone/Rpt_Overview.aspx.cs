...
public partial class Rebelfone_Rpt_Overview : System.Web.UI.Page
{
    ReportDocument doc;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            drpMonth.SelectedValue = DateTime.Now.ToString("MMM");
    ...
    private void DisplayReport()
    {
        ...
        try
        {
            ...
            ds = objSim.GetOverviewReport(start_date, end_date);
            ds1 = objSim.GetOverviewYearReport(drpYearCompare1.SelectedValue, drpYearCompare2.SelectedValue);
