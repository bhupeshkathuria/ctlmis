<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Rpt_Revenue.aspx.cs" Inherits="Rebelfone_Rpt_Revenue" %>
        ...
        <ContentTemplate>
                        ...
                        <tr>
                            <td>
                                ...
                                <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
                                    Width="850px" Height="400px" ToolPanelView="None" />
                            </td>
                        </tr>
                    </table>
                </div>
         ...
         <Triggers>
            <asp:PostBackTrigger ControlID="btnSubmit" />
             ...
             <asp:AsyncPostBackTrigger ControlID="CrystalReportViewer1" EventName="Load" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
