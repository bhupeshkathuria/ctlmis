<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Rpt_Month.aspx.cs" Inherits="Rebelfone_Rpt_Month" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                                    DisplayStatusbar="False" EnableDrillDown="False" GroupTreeStyle-BorderStyle="None"
                                    GroupTreeStyle-ShowLines="False" HasDrilldownTabs="False" Width="850px" Height="400px" />
                            </td>
                        </tr>
                    </table>
                </div>
