...
public partial class Sales_frmShortFallReport : System.Web.UI.Page
{
    ...
    protected void grdview1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (average > 100)
                {
                    Image imgup = (Image)e.Row.Cells[0].FindControl("imgup");
                    imgup.Visible = true;
                }
                else
                {
                    Image imgdown = (Image)e.Row.Cells[0].FindControl("imgdown");
