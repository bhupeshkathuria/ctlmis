                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                        ...
                        <tr style="height: 25px;" >
                                ...
                                <asp:Panel ID="panelfot" runat="server">                              
                                    ...
                                    <td align="right" style="width: 10%">
                                        <asp:Label ID="lblTotalRAFfot" Font-Bold="true" runat="server" ></asp:Label>
                                    </td>
                                    <td align="right" style="width: 15%">
                                        <asp:Label ID="lblTotalBillingfot" Font-Bold="true" runat="server" ></asp:Label>
                                    </td>
                                    <td align="right" style="width: 10%">
                                        <asp:Label ID="lblTotalSTaxfot" Font-Bold="true" runat="server" ></asp:Label>
                                    </td>
                                    <td align="right" style="width: 10%">
                                        <asp:Label ID="lblTotalCRNotefot" Font-Bold="true" runat="server" ></asp:Label>
                                    </td>
                                    <td align="right" style="width: 15%">
                                        <asp:Label ID="lblActualBillingfot" Font-Bold="true" runat="server" ></asp:Label>
                                    </td>
                                    <td align="right" style="width: 10%">
                                        <asp:Label ID="lblARPUfot" runat="server" Font-Bold="true" ></asp:Label>
                                    </td>
                        </tr>
                        </table>
